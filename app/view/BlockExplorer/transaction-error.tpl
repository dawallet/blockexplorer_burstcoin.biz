{include file="header.tpl" siteTitle="Transaction not found" navbar="main"}
    <div class="page-header">
      <h1>Block-Explorer <small>Transaction not found</small></h1>
      <ol class="breadcrumb">
        <li><a href="{$httpUrl}"><span class="glyphicon glyphicon-home"></span> &nbsp;Home</a></li>
        <li><a href="{$httpUrl}blocks">Block-Explorer</a></li>
        <li class="active">Transaction not found</li>
      </ol>
    </div>
